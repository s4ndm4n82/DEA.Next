...
namespace DEA.Next.Graph.GraphEmailActons
{
    internal class GraphGetAttachmentsClass
    {
        ...
        /// <returns></returns>
        public static async Task<int> StartAttachmentDownload(IUserConfigRepository configRepository,
            ...
            Guid customerId)
        {
            ...
            try
            {
                ...
                result = await GraphAttachmentFunctionsClass.GetMessagesWithAttachments(configRepository,
                    requestBuilder,
                    clientEmail,
                    deletedItemsId,
                    maxMails.MaxEmails,
